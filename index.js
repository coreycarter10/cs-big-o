...
// ANSWER:
const numberSquared = numbersArr => {
  let answers = numbersArr.forEach(num, () => Math.pow(num, 2));
  return answers;
}
...
// ANSWER: 
// Both functions are using multiple data sets and are dependent on whatever str is